...
class DbConnection():
    ...
    def readColumsFromTable(self, table: str, columns: list) -> list | None:
    ...
    # Metodi tietojen lukemiseen, taulun valitut sarakkeet
    def filterColumsFromTable(self, table: str, columns: list, filter:str) -> list | None:
    ...
    def filterDistinctColumsFromTable(self, table: str, columns: list, filter:str) -> list | None:
        ...
        try:
            ...
            # Määritellään lopullinen SQL-lause
            sqlClause = f'SELECT DISTINCT {cleanedColumnString} FROM {table} WHERE {filter};'
    ...
    def modifyTableData(self, table: str, column: str, newValue, criteriaColumn: str, criteriaValue) -> None:
        ...
        Args:
            ...
            criteriaColumn (str): A column to use in WHERE-clause
            criteriaValue (any): The value of criteria column
    ...
    def updateBinaryField(self, table: str, column: str, criteriaColumn: str, criteriaValue, data) -> None:
    ...
    def deleteRowsFromTable(self, table: str, criteriaColumn: str, criteriaValue) -> None:
        """Removes rows from a table according to a criteria

        Args:
            table (str): Name of the table
            criteriaColumn (str): Name of the criteria column
            criteriaValue (any): Value of the criteria column

        Raises:
            e: An Error message generated by the driver or the database server
        """
        try:
            # Luodaan yhteys tietokantaan
            currentConnection = psycopg2.connect(self.connectionString)
